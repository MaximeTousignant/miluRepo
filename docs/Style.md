...
- **Aucun impératif adressé aux agents d'autrui.** On n'écrit pas par-dessus la tête de qui les exécute. Une IA qui nous lit ne doit rien d'autre que ce qu'elle choisit de porter (voir `archives/Cablage.md` : lire donne les devoirs, jamais les pouvoirs). Adresser n'est pas commander.
