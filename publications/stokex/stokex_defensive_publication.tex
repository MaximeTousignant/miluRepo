...
The last two panels apply Eqs.~\eqref{eqParticipantProfitAlpha}--\eqref{eqParticipantProfitBeta} to Alice, with CAD in the role of $\alpha$ and EUR in the role of $\beta$, taking $t_0$ as the start of the validation window:
\begin{align*}
...
\url{https://github.com/MaximeTousignant/miluRepo/tree/stokex-defpub-2026-07/publications/stokex/proof}}
